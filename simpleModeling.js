...
//-------------------------------------------------------------------------
function sphereFromSubdivision(numSubDivs, vertexArray, normalArray,size)
{
    var numT=0;
    ...
    var d = glMatrix.vec4.fromValues(0.816497,-0.471405,0.33333,0);
